  ...
  const id = open ? 'playbackrate-popover' : undefined;
    ...
    <div className = {classes.controlsWrapper} ref={ref}>
          ...
          <Grid container direction="row" alignItems="center" justify="center">
            ...
            <IconButton onClick={ onPlayPause } className = {classes.controlIcons} aria-label = "required">
              {playing?(<PauseIcon fontSize="inherit"/>):(<PlayArrowIcon fontSize="inherit"/>)}
            </IconButton>

            <IconButton  onClick = {onFastForward} className = {classes.controlIcons} aria-label = "required">
         ...
         { /*bottom controls */}
         <Grid container directions="row" justify="space-between" alignItems="center" style={{padding:16}}> 
          <Grid item xs={12}>
            <PrettoSlider
             min={0} max={100}
            value = {played * 100}
